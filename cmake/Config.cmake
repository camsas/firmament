...
include_directories(${Firmament_BUILD_DIR})
include_directories(${Firmament_ROOT_DIR}/ext/thread-safe-stl-containers-svn)
include_directories(${Firmament_ROOT_DIR}/ext/spooky_hash)
include_directories(${Firmament_ROOT_DIR}/ext/pb2json-git)

set(SPOOKY_OBJ ${Firmament_ROOT_DIR}/ext/spooky_hash/SpookyV2.o)
set(PB2JSON_OBJ ${Firmament_ROOT_DIR}/ext/pb2json-git/pb2json.o)
