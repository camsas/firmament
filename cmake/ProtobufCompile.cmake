...
function(PROTOBUF_COMPILE BASE_NAME PROTO_PATH GENERATE_GRPC)
  ...
  if(${GENERATE_GRPC})
    set(GRPC_SRC_VAR ${BASE_NAME}_PROTO_GRPC_CC)
    set(GRPC_HDR_VAR ${BASE_NAME}_PROTO_GRPC_H)
    set(GRPC_CC ${PROJECT_BINARY_DIR}/${PROTO_PATH}.grpc.pb.cc)
    set(GRPC_H  ${PROJECT_BINARY_DIR}/${PROTO_PATH}.grpc.pb.h)
    set(${GRPC_SRC_VAR} ${GRPC_CC} PARENT_SCOPE)
    set(${GRPC_HDR_VAR} ${GRPC_H}  PARENT_SCOPE)
  endif(${GENERATE_GRPC})
...
function(PROTOBUF_LIST_COMPILE PBLIST_NAME PB_LIST GENERATE_GRPC)
  ...
  foreach(PB IN ITEMS ${PB_LIST})
    ...
    if(${GENERATE_GRPC})
      set(SRC_LIST ${SRC_LIST} ${${PB_NAME}_PROTO_GRPC_CC})
      set(HDR_LIST ${HDR_LIST} ${${PB_NAME}_PROTO_GRPC_H})
    endif(${GENERATE_GRPC})
  endforeach(PB)
