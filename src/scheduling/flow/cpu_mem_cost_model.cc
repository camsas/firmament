...
ArcDescriptor CpuMemCostModel::LeafResourceNodeToSink(ResourceID_t resource_id) {
...
ArcDescriptor CpuMemCostModel::EquivClassToResourceNode(
    EquivClass_t ec,
    ResourceID_t res_id) {
...
ArcDescriptor CpuMemCostModel::EquivClassToEquivClass(
    EquivClass_t ec1,
    EquivClass_t ec2) {
...
void CpuMemCostModel::AddMachine(
