...
enum DIMACSChangeType {
  ...
  DEL_ARC_BETWEEN_RES = 21,
  CHG_ARC_EVICTED_TASK = 22,
  CHG_ARC_TO_UNSCHED = 23,
  CHG_ARC_FROM_UNSCHED = 24,
  CHG_ARC_TASK_TO_EQUIV_CLASS = 25,
  CHG_ARC_EQUIV_CLASS_TO_RES = 26,
  CHG_ARC_BETWEEN_EQUIV_CLASS = 27,
  CHG_ARC_BETWEEN_RES = 28,
  CHG_ARC_RUNNING_TASK = 29,
  CHG_ARC_TASK_TO_RES = 30,
};
