{
  ...
  "dependencies": [
    {{#TASK_DEPS}}
      "{{TASK_DEP_ID}}"{{#TASK_DEPS_seperator}}, {{/TASK_DEPS_seperator}}
    {{/TASK_DEPS}}
  ],
  "spawned": [
    {{#TASK_SPAWNED}}
      "{{ TASK_SPAWNED_ID }}"{{#TASK_SPAWNED_seperator}}, {{/TASK_SPAWNED_seperator}}
    {{/TASK_SPAWNED}}
  ],
  "outupts": [
    {{#TASK_OUTPUTS}}
      "{{ TASK_OUTPUT_ID }}"{{#TASK_OUTPUTS_seperator}}, {{/TASK_OUTPUTS_seperator}}
    {{/TASK_OUTPUTS}}
  ]
}