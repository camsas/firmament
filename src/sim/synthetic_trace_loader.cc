...
DEFINE_double(prepopulated_cluster_percentage, 0,
              "Percentage of the cluster that is in use at the start of the "
              "simulation");
...
uint64_t SyntheticTraceLoader::NumTasksAtBeginning() {
  return FLAGS_prepopulated_cluster_percentage * FLAGS_synthetic_num_machines *
    num_slots_per_machine_ / 100;
}
