...
#ifndef FIRMAMENT_SIM_QUINCY_TASK_INTERFERENCE_H
#define FIRMAMENT_SIM_QUINCY_TASK_INTERFERENCE_H

#include "sim/task_interference_interface.h"
...
#endif  // FIRMAMENT_SIM_QUINCY_TASK_INTERFERENCE_H
