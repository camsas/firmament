...
#ifndef FIRMAMENT_MISC_SIMULATED_MESSAGING_ADAPTER_H
#define FIRMAMENT_MISC_SIMULATED_MESSAGING_ADAPTER_H
...
#endif  // FIRMAMENT_MISC_SIMULATED_MESSAGING_ADAPTER_H
